package com.songwenju.exoplayerdemo;
...
public class MainActivity extends AppCompatActivity {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            ...
            switch (playbackState){
                ...
                case ExoPlayer.STATE_READY:
                    LogUtil.i(TAG,"ExoPlayer ready! pos: "+exoPlayer.getCurrentPosition()
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FileDialog fileDiaLogUtil = new FileDialog(this, f_ext_files_dir, "");
        fileDiaLogUtil.addFileListener(new FileDialog.FileSelectedListener() {
            @Override
            public void fileSelected(File file) {
                LogUtil.i("File selected:",file.getAbsolutePath());
                ...
                try {
                    ...
                    LogUtil.i(TAG,"Data before read: "+fileData.length);
                    int bytesRead = inputStream.read(fileData);
                    LogUtil.i(TAG,"Bytes read: "+bytesRead);
                    if(bytesRead>0) {
    ...
    private void prepareExoPlayerFromByteArray(byte[] data){
        ...
        LogUtil.i(TAG,"ByteArrayDataSource constructed.");
        /*
